...
public class CreateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Wallet wallet = new Wallet(last_name, first_name, middle_name, passport_id, rub, usd, eur);
            ErrorChecker.createChecker(wallet);
            if (ErrorChecker.ans){
                ArrayList <String> errors = ErrorChecker.createChecker(wallet);
